...
// CreateOrder - mock response
var CreateOrder = new(taxjar.CreateOrderResponse)
var _ = json.Unmarshal([]byte(CreateOrderJSON), &CreateOrder)

// CreateOrderJSON - mock CreateOrder JSON
var CreateOrderJSON = `{
  "order": {
    "transaction_id": "24",
    "user_id": 121449,
