...
// ShowRefund - mock response
var ShowRefund = new(taxjar.ShowRefundResponse)
var _ = json.Unmarshal([]byte(ShowRefundJSON), &ShowRefund)

// ShowRefundJSON - mock ShowRefund JSON
var ShowRefundJSON = `{
  "refund": {
