...
// CreateRefund - mock response
var CreateRefund = new(taxjar.CreateRefundResponse)
var _ = json.Unmarshal([]byte(CreateRefundJSON), &CreateRefund)

// CreateRefundJSON - mock CreateRefund JSON
var CreateRefundJSON = `{
  "refund": {
